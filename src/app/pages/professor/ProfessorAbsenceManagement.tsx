...
export default function ProfessorAbsenceManagement() {
  ...
  const handleReject = async (absenceId: number) => { // id: string -> absenceId: number
  ...
  return (
    <div className="max-w-7xl mx-auto pb-10 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">학생들의 공결 신청을 검토하고 승인 또는 반려하세요</p>
      </div>
          ...
          {activeTab === "pending" ? (
            pendingRequests.length > 0 ? (
                ...
                {pendingRequests.map((request, index) => (
                  ...
                  >
                    ...
                    <div className="bg-zinc-50 rounded-xl p-3 flex-1 mb-4">
                      <div className="text-xs text-zinc-400 mb-1">결석일: {request.date}</div>
              ...
              <div className="py-16 text-center flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-medium text-zinc-500">대기 중인 신청이 없습니다</p>
                <p className="text-xs text-zinc-400 mt-1">모든 공결 신청을 처리했습니다.</p>
              </div>
            )
          ) : (
            <div className="space-y-3">
              {processedRequests.length > 0 ? (
                ...
                <div className="py-16 text-center flex flex-col items-center justify-center">
                  ...
                  <p className="text-sm font-medium text-zinc-500">처리된 신청이 없습니다</p>
                  <p className="text-xs text-zinc-400 mt-1">처리된 공결 신청 내역이 없습니다.</p>
                </div>
              )}
            </div>
          )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-900/20 backdrop-blur-sm">
            ...
            >
              <div className="px-6 py-4 border-b border-zinc-100 flex justify-between items-center">
                <h3 className="text-base font-semibold text-zinc-900 flex items-center gap-2">
                  <FileText className="w-4 h-4 text-zinc-400" strokeWidth={1.5} /> 공결 신청 검토서
                </h3>
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="bg-zinc-50 rounded-xl p-4">
                  <div className="text-xs text-zinc-400 mb-2">결석 사유 상세</div>
