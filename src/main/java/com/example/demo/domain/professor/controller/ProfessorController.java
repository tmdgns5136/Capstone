...
public class ProfessorController {
    ...
    @GetMapping("/lectures/{lectureId}/devices")
    public ApiResponse<List<ProfessorLectureDeviceResponse>> getLectureDevices(
            @PathVariable("lectureId") String lectureId,
            Authentication authentication
    ) {
        String professorNum = authentication.getName();
        ...
        return ApiResponse.success(200, professorService.getLectureDevices(professor.getProfessorId(), lectureId));
    }
