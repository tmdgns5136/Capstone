...
public class LectureController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<List<LectureData>>> getMyLecture(@RequestParam("year") Long year,
    ...
    public ResponseEntity<ActionResponse> deleteOfficialAbsence(@PathVariable("lecture_id")Long lectureId,
                                                             @PathVariable("requestId") Long requestId,
                                                             Authentication authentication){
    ...
    public ResponseEntity<ActionResponse> deleteObjectionAbsence(@PathVariable("lecture_id")Long lectureId,
                                                             @PathVariable("requestId") Long requestId,
                                                             Authentication authentication){
    ...
    public ResponseEntity<ApiResponse<List<LectureTimeTable>>> getTimeTable(Authentication authentication, @RequestParam("year") Long year, @RequestParam("semester") String semester){
    ...
    public ResponseEntity<ApiResponse<NoticeDetailData>> getNoticeDetail(Authentication authentication,
                                                                         @PathVariable("lecture_id")Long lectureId,
                                                                         @PathVariable("notice_id")Long noticeId){
        ApiResponse<NoticeDetailData> apiResponse = lectureService.getNoticeDetail(authentication, lectureId, noticeId);
        return ResponseEntity.ok(apiResponse);
    }
    ...
    public ResponseEntity<ApiResponse<QuestionRequestResponse>> requestQuestion(Authentication authentication, @PathVariable("lecture_id")Long lectureId,
                                                                                @RequestBody QuestionRequest questionRequest){
        ApiResponse<QuestionRequestResponse> apiResponse = lectureService.questionRequest(authentication, lectureId, questionRequest);
        return ResponseEntity.ok(apiResponse);
    }
    ...
    public ResponseEntity<ApiResponse<QuestionDetailData>> getQuestionDetail(@PathVariable("lecture_id") Long lectureId,
                                                             @PathVariable("question_id") Long questionId, Authentication authentication) {
        ApiResponse<QuestionDetailData> apiResponse = lectureService.getDetailQuestion(authentication, lectureId, questionId);
        return ResponseEntity.ok(apiResponse);
    }
    ...
    public ResponseEntity<ActionResponse> deleteQuestions(Authentication authentication, @PathVariable("lecture_id") Long lectureId,
                                                          @PathVariable("question_id")Long questionId){
        ActionResponse actionResponse = lectureService.deleteQuestion(authentication, lectureId, questionId);
        return ResponseEntity.ok(actionResponse);
    }
