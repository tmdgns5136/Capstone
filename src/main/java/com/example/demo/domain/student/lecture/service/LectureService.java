...
public class LectureService {
    ...
    public ApiResponse<StatsData> getStats(Authentication authentication, Long lectureId){
        ...
        long attendance = myAttendances.stream().filter(a -> a.getAttendStatus() == AttendStatus.PRESENT).count();
        long absence = myAttendances.stream().filter(a -> a.getAttendStatus() == AttendStatus.ABSENT).count();
        long late = myAttendances.stream().filter(a -> a.getAttendStatus() == AttendStatus.LATE).count();
