-- 샘플 계정의 비밀번호는 모두 1234입니다. (BCrypt 인코딩)
-- ── 교수 ──
...
VALUES
(1, '김교수', '$2a$10$/Fc6cWrfieih.NrB0npfM.MJ0oCI.Y.Qnr.vCNi8xeY22IOmAF/bu', '202611', 'kimprof@univ.ac.kr', '컴퓨터공학', '010-1111-1111', 'PROFESSOR', 'EMPLOYED');

-- ── 학생 ──
INSERT IGNORE INTO student
(STUDENT_ID, STUDENT_NUM, STUDENT_NAME, STUDENT_EMAIL, STUDENT_PHONENUM, STUDENT_PASSWORD, ROLE_TYPE, STUDENT_STATUS)
VALUES
(1, '202100001', '학생1', 'stu1@univ.ac.kr', '010-2001-0001', '$2a$10$/Fc6cWrfieih.NrB0npfM.MJ0oCI.Y.Qnr.vCNi8xeY22IOmAF/bu', 'STUDENT', 'ENROLLED'),
(2, '202100002', '학생2', 'stu2@univ.ac.kr', '010-2001-0002', '$2a$10$/Fc6cWrfieih.NrB0npfM.MJ0oCI.Y.Qnr.vCNi8xeY22IOmAF/bu', 'STUDENT', 'ENROLLED'),
(3, '202100003', '학생3', 'stu3@univ.ac.kr', '010-2001-0003', '$2a$10$/Fc6cWrfieih.NrB0npfM.MJ0oCI.Y.Qnr.vCNi8xeY22IOmAF/bu', 'STUDENT', 'ENROLLED');

-- ── 강의 (2026년 1학기, 단일 요일) ──
INSERT IGNORE INTO lecture
...
-- ── 수강 등록 ──
INSERT IGNORE INTO enrollment (ENROLLMENT_ID, LECTURE_ID, STUDENT_ID) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 2),
(4, 2, 3);
...
VALUES
(1, '병원 진료', '정기 검진으로 인한 결석', 'files/medical.pdf', 'medical.pdf', 'PENDING', null, '2026-03-11 10:00:00', 1, 1, 1, 2),
(2, '가족 행사', '가족 결혼식 참석', 'files/family-event.pdf', 'family-event.pdf', 'APPROVED', null, '2026-03-13 09:00:00', 2, 1, 1, 1);
...
VALUES
(1, '출석 인식 오류', '얼굴 인식 단말기가 정상적으로 인식하지 못했습니다.', 'files/recognition-error.txt', 'PENDING', null, '2026-03-18 11:00:00', 1, 1, 1, 2),
(2, '결석 처리 이의', '정상적으로 출석했는데 결석으로 처리되었습니다.', 'files/attendance-appeal.txt', 'APPROVED', null, '2026-03-19 14:00:00', 2, 1, 1, 1);
